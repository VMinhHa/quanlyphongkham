...
<center><hr width="200"></center>
	<div class="row mt-2">
		...
		<div class="col-6.5">
			...
			<p><a href="doimk_benhnhan.php" >Cập Nhật<img src="./images/edit.svg" width="20px" class="ml-1"></a></p>
                ...
                <div class="modal-body">
                  ...
                  <form action="capnhatthongtin.php" method="POST">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" name="email" required="required" value="<?php echo $dsbenhnhan['Email']; ?>">
                    </div>
                </div>
