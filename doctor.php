  ...
  <div class="container">
      ...
      <div class="col-12 text-center  mb-5">
	        <div class="btn-group btn-group-toggle " data-toggle="buttons">
	          ...
	          <label class="btn">
	            <input type="radio" name="shuffle-filter" value="cat2" />Nha khoa
	          </label>
	          <label class="btn">
	            <input type="radio" name="shuffle-filter" value="cat3" />Thần kinh
	          </label>
	          <label class="btn">
	            <input type="radio" name="shuffle-filter" value="cat4" />Y học cổ truyền
	          </label>
	           <label class="btn">
	            <input type="radio" name="shuffle-filter" value="cat5" />Nhi khoa
	          </label>
	          <label class="btn">
